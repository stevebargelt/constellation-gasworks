...
if (import.meta.env.VITE_NEW_RELIC_APP_ID && import.meta.env.VITE_NEW_RELIC_LICENSE_KEY) {
  new BrowserAgent({
    ...
    loader_config: { accountID: import.meta.env.VITE_NEW_RELIC_ACCOUNT_ID ?? "", trustKey: "", agentID: import.meta.env.VITE_NEW_RELIC_APP_ID, licenseKey: import.meta.env.VITE_NEW_RELIC_LICENSE_KEY, applicationID: import.meta.env.VITE_NEW_RELIC_APP_ID },
  });
}
